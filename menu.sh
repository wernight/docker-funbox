...
case $choice in
  ...
  '9') bb;;
  '10') sl;;
  '11') cowsay 'wernight/funbox';;
  '12') figlet 'wernight/funbox';;
  '13') toilet 'wernight/funbox';;
  '14') convert /examples/blob-beroux.png ~/blob-beroux.pgm && aview ~/blob-beroux.pgm;;
  '15') cacaview examples/blob-beroux.png;;
  '16') fortune | boxes -d parchment;;
  '17') binclock;;
  '18') linuxlogo;;
  '19') cat /examples/0?.txt | lolcat -a -d 1 -F 0.09;;
  '20') rig;;
  '21') fortune;;
